...
StarryOS是一个基于Rust语言开发的嵌入式AIoT操作系统，专门为RK3588等高端AIoT开发板设计。系统集成了完整的语音交互、计算机视觉和多模态AI融合功能，具备高性能、高安全性和易扩展的特点。后续继续优化加入deepseek升级yolo11和扩展，逐步实现语音助理、智能家居、安防监控等AIoT应用。
